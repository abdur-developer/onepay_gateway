...
<body cz-shortcut-listen="true">
    ...
    <div style="margin-top: -125px; background: rgb(49, 51, 129); height: 100vh;" class="px-4">
        <div class="mb-4">
            <div class="d-flex align-items-center" style="gap: 5px;">
                <img src=https://onepays.news/checkoutdata/onepay/img/pixlogo.2432dd36.png"
                    style="height: 28px; weight: 28px;">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <div class="">
                <p class="mb-0"
                    style="text-align:center;font-size: 30px; color: #fff;font-family: 'Gilroy-Heavy',sans-serif;font-weight: 700;">
                    10 TK
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4">
                    <ul style="list-style: none;margin: 0;padding: 0">
                        ...
                        <li class="single-details mt-4">প্রকৃত অর্থপ্রদানের পরিমাণ : <span> 10
                            </span></li>
                    </ul>
                </div>
            </div>
    ...
    <script>
    setTimeout(function() {
        //window.location.href = "https://xerox-company.top/activitionverifys?invoice_id=S6931344119740518726&amp;&amp;trxid=ANcUvjmVut&amp;&amp;getway=Nagad&amp;&amp;status=success";
    }, 5000);
    </script>
