...
<head>
  ...
  <title>Nagad Payment Gateway</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"/>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"/>
  <link rel="stylesheet" href="next.css">
  <style>
    :root {
      --primary-color: #F60002;
      --secondary-color: #EB5F1B;
      --dark-color: #2d2d2d;
      --light-color: #f8f9fa;
        ...
        <div class="payment-card animation-pulse">
          ...
          <div class="payment-header">
            <div class="logo-container">
              <img src="https://play-lh.googleusercontent.com/PJk1SwaOAOo_zD8Yh03TPVhWbzUJ2peIXquqFjcLPIJKXKLqCyd8PT4XyPgeq4IMNw=w240-h480-rw" alt="Nagad Logo" class="logo" style="border-radius: 30%"/>
            </div>
            <h4>Secure Payment with Nagad</h4>
          </div>
          ...
          <div class="payment-body">
            <div class="step">
              ...
              <div class="step-content">
                <strong>Dial *167#</strong> on your mobile phone
                <div class="text-muted small mt-1">Open your Nagad mobile menu</div>
              </div>
            </div>
            ...
            <div class="step">
              ...
              <div class="step-content">
                ...
                <div class="text-muted small mt-1">From the Nagad menu options</div>
              </div>
            </div>
            ...
            <div class="step">
              ...
              <div class="step-content">
                Enter the recipient Nagad number
                <div class="copy-section">
                  <span class="copy-text" id="nagad-number"><?=$method['number']?></span>
                  <button class="copy-btn" onclick="copyToClipboard('nagad-number','<?=$method['number']?>')">
            ...
            <div class="step">
              ...
              <div class="step-content">
                Enter your <strong>Nagad PIN</strong> to confirm
